...
#define PT_LCD_HSYNC_PULSE_WIDTH 40
#define PT_LCD_VSYNC_PULSE_WIDTH 13
#define PT_LCD_HSYNC_BACK_PORCH 40
#define PT_LCD_VSYNC_BACK_PORCH 31
#define PT_LCD_HSYNC_FRONT_PORCH 48
#define PT_LCD_VSYNC_FRONT_PORCH 1
#define PT_LCD_PCLK_HZ 12000000
